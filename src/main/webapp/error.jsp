...
.four_zero_four_bg{ 
 background-image: url(/news-management-spring/resources/images/dribbble_1.gif);
    height: 400px;
...
<body>
  ...
  <div class="container">
    ...
    <a href="news/list" class="link_404"><spring:message code="local.loc.name.link_404"/></a>
  </div>
    </div>
    </div>
    </div>
